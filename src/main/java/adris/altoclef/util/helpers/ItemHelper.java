...
public class ItemHelper {
    ...
    public static final Item[] PLANKS = new Item[]{Items.ACACIA_PLANKS, Items.BIRCH_PLANKS, Items.CHERRY_PLANKS, Items.CRIMSON_PLANKS, Items.DARK_OAK_PLANKS, Items.MANGROVE_PLANKS, Items.OAK_PLANKS, Items.JUNGLE_PLANKS, Items.PALE_OAK_PLANKS, Items.SPRUCE_PLANKS, Items.WARPED_PLANKS};
    public static final Item[] LEAVES = new Item[]{Items.ACACIA_LEAVES, Items.BIRCH_LEAVES, Items.CHERRY_LEAVES, Items.DARK_OAK_LEAVES, Items.MANGROVE_LEAVES, Items.OAK_LEAVES, Items.JUNGLE_LEAVES, Items.PALE_OAK_LEAVES, Items.SPRUCE_LEAVES};
    public static final Item[] WOOD = new Item[]{Items.ACACIA_WOOD, Items.BIRCH_WOOD, Items.CHERRY_WOOD, Items.CRIMSON_HYPHAE, Items.DARK_OAK_WOOD, Items.MANGROVE_WOOD, Items.OAK_WOOD, Items.JUNGLE_WOOD, Items.PALE_OAK_WOOD, Items.SPRUCE_WOOD, Items.WARPED_HYPHAE};
    public static final Item[] WOOD_BUTTON = new Item[]{Items.ACACIA_BUTTON, Items.BIRCH_BUTTON, Items.CHERRY_BUTTON, Items.CRIMSON_BUTTON, Items.DARK_OAK_BUTTON, Items.MANGROVE_BUTTON, Items.OAK_BUTTON, Items.JUNGLE_BUTTON, Items.PALE_OAK_BUTTON, Items.SPRUCE_BUTTON, Items.WARPED_BUTTON};
    public static final Item[] WOOD_SIGN = new Item[]{Items.ACACIA_SIGN, Items.BIRCH_SIGN, Items.CHERRY_SIGN, Items.CRIMSON_SIGN, Items.DARK_OAK_SIGN, Items.MANGROVE_SIGN, Items.OAK_SIGN, Items.JUNGLE_SIGN, Items.PALE_OAK_SIGN, Items.SPRUCE_SIGN, Items.WARPED_SIGN};
    public static final Item[] WOOD_PRESSURE_PLATE = new Item[]{Items.ACACIA_PRESSURE_PLATE, Items.BIRCH_PRESSURE_PLATE, Items.CHERRY_PRESSURE_PLATE, Items.CRIMSON_PRESSURE_PLATE, Items.DARK_OAK_PRESSURE_PLATE, Items.MANGROVE_PRESSURE_PLATE, Items.OAK_PRESSURE_PLATE, Items.JUNGLE_PRESSURE_PLATE, Items.PALE_OAK_PRESSURE_PLATE, Items.SPRUCE_PRESSURE_PLATE, Items.WARPED_PRESSURE_PLATE};
    public static final Item[] WOOD_FENCE = new Item[]{Items.ACACIA_FENCE, Items.BIRCH_FENCE, Items.CHERRY_FENCE, Items.DARK_OAK_FENCE, Items.MANGROVE_FENCE, Items.OAK_FENCE, Items.JUNGLE_FENCE, Items.PALE_OAK_FENCE, Items.SPRUCE_FENCE, Items.CRIMSON_FENCE, Items.WARPED_FENCE};
    public static final Item[] WOOD_FENCE_GATE = new Item[]{Items.ACACIA_FENCE_GATE, Items.BIRCH_FENCE_GATE, Items.CHERRY_FENCE_GATE, Items.DARK_OAK_FENCE_GATE, Items.MANGROVE_FENCE_GATE, Items.OAK_FENCE_GATE, Items.JUNGLE_FENCE_GATE, Items.PALE_OAK_FENCE_GATE, Items.SPRUCE_FENCE_GATE, Items.CRIMSON_FENCE_GATE, Items.WARPED_FENCE_GATE};
    public static final Item[] WOOD_BOAT = new Item[]{Items.ACACIA_BOAT, Items.BIRCH_BOAT, Items.CHERRY_BOAT, Items.DARK_OAK_BOAT, Items.MANGROVE_BOAT, Items.OAK_BOAT, Items.JUNGLE_BOAT, Items.PALE_OAK_BOAT, Items.SPRUCE_BOAT};
    public static final Item[] WOOD_DOOR = new Item[]{Items.ACACIA_DOOR, Items.BIRCH_DOOR, Items.CHERRY_DOOR, Items.CRIMSON_DOOR, Items.DARK_OAK_DOOR, Items.MANGROVE_DOOR, Items.OAK_DOOR, Items.JUNGLE_DOOR, Items.PALE_OAK_DOOR, Items.SPRUCE_DOOR, Items.WARPED_DOOR};
    public static final Item[] WOOD_SLAB = new Item[]{Items.ACACIA_SLAB, Items.BIRCH_SLAB, Items.CHERRY_SLAB, Items.CRIMSON_SLAB, Items.DARK_OAK_SLAB, Items.MANGROVE_SLAB, Items.OAK_SLAB, Items.JUNGLE_SLAB, Items.PALE_OAK_SLAB, Items.SPRUCE_SLAB, Items.WARPED_SLAB};
    public static final Item[] WOOD_STAIRS = new Item[]{Items.ACACIA_STAIRS, Items.BIRCH_STAIRS, Items.CHERRY_STAIRS, Items.CRIMSON_STAIRS, Items.DARK_OAK_STAIRS, Items.MANGROVE_STAIRS, Items.OAK_STAIRS, Items.JUNGLE_STAIRS, Items.PALE_OAK_STAIRS, Items.SPRUCE_STAIRS, Items.WARPED_STAIRS};
    public static final Item[] WOOD_TRAPDOOR = new Item[]{Items.ACACIA_TRAPDOOR, Items.BIRCH_TRAPDOOR, Items.CHERRY_TRAPDOOR, Items.CRIMSON_TRAPDOOR, Items.DARK_OAK_TRAPDOOR, Items.MANGROVE_TRAPDOOR, Items.OAK_TRAPDOOR, Items.JUNGLE_TRAPDOOR, Items.PALE_OAK_TRAPDOOR, Items.SPRUCE_TRAPDOOR, Items.WARPED_TRAPDOOR};
    public static final Item[] LOG = new Item[]{Items.ACACIA_LOG, Items.BIRCH_LOG, Items.CHERRY_LOG, Items.DARK_OAK_LOG, Items.MANGROVE_LOG, Items.OAK_LOG, Items.JUNGLE_LOG, Items.PALE_OAK_LOG, Items.SPRUCE_LOG,
            Items.ACACIA_WOOD, Items.BIRCH_WOOD, Items.CHERRY_WOOD, Items.DARK_OAK_WOOD, Items.MANGROVE_WOOD, Items.OAK_WOOD, Items.JUNGLE_WOOD, Items.PALE_OAK_WOOD, Items.SPRUCE_WOOD,
            Items.STRIPPED_ACACIA_LOG, Items.STRIPPED_BIRCH_LOG, Items.STRIPPED_CHERRY_LOG, Items.STRIPPED_DARK_OAK_LOG, Items.STRIPPED_MANGROVE_LOG, Items.STRIPPED_OAK_LOG, Items.STRIPPED_JUNGLE_LOG, Items.STRIPPED_PALE_OAK_LOG, Items.STRIPPED_SPRUCE_LOG,
            Items.STRIPPED_ACACIA_WOOD, Items.STRIPPED_BIRCH_WOOD, Items.STRIPPED_CHERRY_WOOD, Items.STRIPPED_DARK_OAK_WOOD, Items.STRIPPED_MANGROVE_WOOD, Items.STRIPPED_OAK_WOOD, Items.STRIPPED_JUNGLE_WOOD, Items.STRIPPED_PALE_OAK_WOOD, Items.STRIPPED_SPRUCE_WOOD,
    ...
    public static final Block[] WOOD_SIGNS_ALL = new Block[]{Blocks.ACACIA_SIGN, Blocks.BIRCH_SIGN, Blocks.CHERRY_SIGN, Blocks.CRIMSON_SIGN, Blocks.DARK_OAK_SIGN, Blocks.MANGROVE_SIGN, Blocks.OAK_SIGN, Blocks.JUNGLE_SIGN, Blocks.PALE_OAK_SIGN, Blocks.SPRUCE_SIGN, Blocks.WARPED_SIGN, Blocks.ACACIA_WALL_SIGN, Blocks.BIRCH_WALL_SIGN, Blocks.CHERRY_WALL_SIGN, Blocks.CRIMSON_WALL_SIGN, Blocks.DARK_OAK_WALL_SIGN, Blocks.MANGROVE_WALL_SIGN, Blocks.OAK_WALL_SIGN, Blocks.JUNGLE_WALL_SIGN, Blocks.PALE_OAK_WALL_SIGN, Blocks.SPRUCE_WALL_SIGN, Blocks.WARPED_WALL_SIGN};
